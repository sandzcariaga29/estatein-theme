...
<section class="features-grid container">
  ...
  for ( $i = 1; $i <= 4; $i++ ) { 
      // Notice the 'option' parameter added here! This tells ACF to look at your Theme Settings page.
      $feature_title = get_field('feature_' . $i . '_title', 'option');
      $feature_icon  = get_field('feature_' . $i . '_icon', 'option');
